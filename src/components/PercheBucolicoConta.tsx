...
export default function PercheBucolicoConta() {
  ...
  return (
    <section ref={containerRef} className="py-32 bg-brand-white relative overflow-hidden min-h-screen">
      <motion.div
        className="absolute inset-0 bg-brand-peach/30 -z-0"
        style={{ y: bgY }}
      />
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-bold text-brand-red mb-4">
        ...
        <div className="grid md:grid-cols-2 gap-8 mt-16">
          <motion.div
            ...
            viewport={{ once: true }}
            className="bg-brand-white p-8 rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-300 border border-brand-peach/20"
          >
